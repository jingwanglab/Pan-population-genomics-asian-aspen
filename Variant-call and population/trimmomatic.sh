#!/bin/bash
set -e
OUTDIR="/xx/clean_data"
Userhome="/w/00/u/user206"
juqun_file="/w/00/u/user206/juqun.txt"
Trimmomatic="/data/apps/trimmomatic/Trimmomatic-0.36"
rawfile1="/w/00/u/user206/merge_needless.txt"
rawfile2="/w/00/u/user206/merge_need.txt"
